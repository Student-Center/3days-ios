...
extension ProfileIntroModel: ProfileIntroModel.Stateful {}

//MARK: - Actionable
protocol ProfileIntroModelActionable: AnyObject {
    // content
...
extension ProfileIntroModel: ProfileIntroModelActionable {
    // content
    func setValidation(value: Bool) {
        isValidated = value
    }
