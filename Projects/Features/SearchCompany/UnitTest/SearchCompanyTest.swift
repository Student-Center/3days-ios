//
//  SearchCompanyTest.swift
//  SearchCompany-UnitTest
//
...
import XCTest
@testable import SearchCompany
import Model
import NetworkKit
import CommonKit

class SearchCompanyTest: XCTestCase {
    var state: SearchCompanyModel!
    var intent: SearchCompanyIntent!
